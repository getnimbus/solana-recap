    ...
    <table class="table-auto xl:w-full w-[1400px]">
      <thead>
        <tr class="bg_f4f5f8">
          ...
          >
            <div class="text-xs font-semibold uppercase text-left">Supply</div>
          </th>

          <th class="py-3">
            <div class="text-left text-xs font-semibold uppercase">
              Supply Balance
            </div>
          </th>

          <th class="py-3">
            <div class="text-xs font-semibold uppercase text-left">Borrow</div>
          </th>
          ...
          <th class="py-3">
            <div
              class="text-left flex items-center gap-1 text-xs font-semibold uppercase"
            >
              Health
              <span
