...
<div class="flex flex-col justify-between xl:gap-6 gap-5 xl:flex-row">
  <!-- Token allocation -->
  <div
    class={`xl:w-1/2 w-full flex flex-col justify-between items-start gap-2 rounded-[20px] xl:p-6 py-4 lg:px-3 xl:border border_0000001a ${
      $isDarkMode ? "lg:bg-[#222222]" : "bg-[#fff]"
    }`}
  >
    <div class="font-medium text-2xl">Token Allocation</div>
    ...
    <div class="flex md:flex-row flex-col justify-end w-full gap-5">
      ...
      >
        ...
        <div
          class="flex gap-3 overflow-x-auto w-max px-2 whitespace-nowrap"
      ...
      <div class="flex-1 w-max">
        {#if $user && Object.keys($user).length !== 0}
          <div
            ...
            class="mt-1 font-medium text-blue-500 cursor-pointer text-base hover:underline w-max"
          >
            Custom category
          </div>
        {:else}
          <div
            class="mt-1 font-medium text-gray-500 cursor-pointer text-base hover:underline w-max"
          >
            Custom category
          </div>
        {/if}
          ...
          {:else}
            <div class="relative">
              <div class="xl:block hidden">
                <EChart
                  id="current-status-analytics-dekstop"
                  {theme}
                  notMerge={true}
                  option={optionPie}
                  height={475}
              ...
              <div class="xl:hidden block">
                <EChart
                  id="current-status-analytics-mobile"
                  {theme}
                  notMerge={true}
                  option={optionPie}
                  height={265}
              ...
              {#if isNimbusVersion}
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    class="xl:w-[140px] xl:h-[140px] w-[110px] h-[110px]"
                  />
                </div>
              {/if}
            </div>
  ...
  <!-- Performance -->
  <div
    class={`xl:w-1/2 w-full relative rounded-[20px] xl:p-6 py-4 lg:px-3 xl:border border_0000001a ${
      $isDarkMode ? "lg:bg-[#222222]" : "bg-[#fff]"
    }`}
  >
    <div
