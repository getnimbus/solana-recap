  ...
  <div class="flex flex-col gap-6 items-center justify-center">
    ...
    <div class="flex flex-col gap-8">
      <div class="text-xl text-center">
        {#if mobileOperationSystem === "Android"}
          Please open {#if isNimbusVersion}Nimbus{/if}
          app in your browser to install this app Click on
        ...
        {#if mobileOperationSystem === "iOS"}
          ...
          >
          in the options. Then open {#if isNimbusVersion}Nimbus{/if}
          app in your home screen
        {/if}
      </div>
