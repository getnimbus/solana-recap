...
>
  <div class="flex flex-col gap-3">
    ...
    <div class="text-lg">Telegram</div>
  </div>
  ...
  <div class="flex flex-col gap-3">
    ...
    {:else}
      ...
      <div
        class="relative flex items-center justify-center gap-2 text-white py-3 px-6 rounded-[12px] w-full bg-[#1e96fc] cursor-pointer"
        on:click={() => {
      ...
      >
        <div class="font-semibold text-[15px] relative z-9 cursor-pointer">
          {$t("Connect")}
        </div>
        <div
