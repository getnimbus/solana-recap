...
<div class="xl:flex hidden flex-col gap-4">
  <div class="text-xl font-medium w-full">Compare with other apps</div>
  <div
    ...
    <table class="xl:w-full w-[1400px] table-auto">
      <thead>
        <tr class="bg_f4f5f8">
          ...
          >
            <div class="text-left text-sm uppercase font-medium">#</div>
          </th>
          <th class="py-3">
            <div class="text-left text-sm uppercase font-medium">Nimbus</div>
          </th>
          <th class="py-3">
            <div class="text-left text-sm uppercase font-medium">Excel</div>
          </th>
          <th class="py-3">
            <div class="text-left text-sm uppercase font-medium">CoinStats</div>
          </th>
          <th class="py-3">
            <div class="text-left text-sm uppercase font-medium">DeBank</div>
          </th>
          <th class="py-3 rounded-tr-[10px]">
            <div class="text-left text-sm uppercase font-medium">Nansen</div>
          </th>
        </tr>
      </thead>
      <tbody>
